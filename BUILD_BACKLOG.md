...
**Status:** Living tracking document. **Baseline as of:** spec v2.31 / research doc v2.24 (2026-09-17).
...
- [x] **Waitlist auto-notify** — the last deferred item from Phase 2/3: cancelling an appointment now auto-notifies every matching waitlist entry (mock send, opt-in gated), with staff-visible audit trail. **Done, v2.31** — see §5a, baseline spec §50. Pick up the Phase 3 real-vendor follow-up, the Phase 4 portal follow-ups, or another item from the sections below.
