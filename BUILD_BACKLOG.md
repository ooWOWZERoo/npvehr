...
**Status:** Living tracking document. **Baseline as of:** spec v2.28 / research doc v2.24 (2026-09-16).
...
- [x] **Calendar & Appointments UX Overhaul, Phase 2 (Waitlist Management)** — new `WaitlistEntry` model, per-patient tab, staff-facing global queue, matching entries surfaced on appointment cancellation. **Done, v2.28** — see §5a, baseline spec §47. Pick up Phase 3 (reminders/auto-notify) or Phase 4 (self-booking) next, or another item from the sections below.
