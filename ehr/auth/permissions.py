...
# Same narrower-than-EDIT posture as EXAM_SIGN above: signing a prescription
# is a clinical attestation, so Optician (dispensing-focused, not a
# prescribing role) and Practice Administrator don't get it even though both
# have RX_EDIT.
RX_SIGN = {SYSTEM_ADMINISTRATOR, OPTOMETRIST_PROVIDER}
