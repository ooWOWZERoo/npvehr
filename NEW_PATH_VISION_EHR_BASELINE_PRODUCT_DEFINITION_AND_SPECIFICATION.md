...
**Document version:** 2.18 (supersedes v2.17; builds the fifth and last of five clinical dashboards, Pre-/Post-Operative Co-Management, plus its surgical timeline view — new `SurgeryComanagementTracking` table, a fifth Visit Focus chip, a composer extension, and a new patient-workspace tab; see §12.5g; all five clinical dashboards from `VISION_EHR_DATA_STANDARDS_RESEARCH.md` §5 are now built; none of this bears on the four go-live prerequisites, which are unchanged from v2.6)
