...
**Document version:** 2.12 (supersedes v2.11; auto-populates the free-text Assessment/Plan fields on the new-exam form from the structured fields built in §12.5a/§12.5b — a client-side composer, editable and never locked, no schema change; see §12.5c; none of this bears on the four go-live prerequisites, which are unchanged from v2.6)
