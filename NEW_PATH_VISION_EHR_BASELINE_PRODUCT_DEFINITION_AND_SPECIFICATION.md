...
- Optical products, frame inventory, lens options, orders, lab tracking, dispensing, warranties, or remakes.
- Medication, allergy coding, problem lists, procedure coding, superbills, or clinical decision support.
...
- APIs intended for external consumers, FHIR resources, webhooks, or integrations.
